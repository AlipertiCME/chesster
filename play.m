...
if calib == "Y"
    blank = calibrateCamera(camDir, landingDir, camKillBatDir); % replace with "calibration file once function is created 
else 
...
s.Timeout = 600; % Set the timeout to 10 minutes
pause(2);
